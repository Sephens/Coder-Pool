...
public class adapter2 extends RecyclerView.Adapter<adapter.viewHolder> {
    public adapter2(ArrayList<SlideAdapterHelper> slideHelper){
    ...
    public static class viewHolder extends RecyclerView.ViewHolder{
        ...
        public viewHolder(@NonNull View itemView) {
            super(itemView);
            image = itemView.findViewById(R.id.card_2_img);
            title = itemView.findViewById(R.id.card_2_title);
            description = itemView.findViewById(R.id.card_2_description);
        }
    }
