...
public class adapter3 extends RecyclerView.Adapter<adapter.viewHolder> {
    public adapter3(ArrayList<SlideAdapterHelper> slideHelper){
    ...
    public static class viewHolder extends RecyclerView.ViewHolder{
        ...
        public viewHolder(@NonNull View itemView) {
            super(itemView);
            image = itemView.findViewById(R.id.card_3_img);
            title = itemView.findViewById(R.id.card_3_title);
            description = itemView.findViewById(R.id.card_3_description);
        }
    }
